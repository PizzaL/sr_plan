...
static
void *ProjectSet_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CreatePublicationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *ObjectWithArgs_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *TableFuncScan_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *SQLValueFunction_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CreateAmStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *RangeTableFunc_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *GatherMerge_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *TriggerTransition_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *TableFunc_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *TypeCast_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *Gather_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *PartitionRangeDatum_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *AlterObjectDependsStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CreateSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *RangeTableFuncCol_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *RawStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *NextValueExpr_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *PartitionSpec_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CallContext_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *AlterCollationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CallStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *PartitionElem_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *PartitionBoundSpec_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *NamedTuplestoreScan_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *AlterSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *DropSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *AlterOperatorStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *IndexScan_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *PartitionCmd_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *CreateStatsStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
static
void *VacuumRelation_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *AlterTSConfigurationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
void *AlterPublicationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type);
static
...
void *CreateSchemaStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->authrole = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *ProjectSet_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	ProjectSet *local_node;
	if (node_cast != NULL)
		local_node = (ProjectSet *) node_cast;
	else
		local_node = makeNode(ProjectSet);
...
void *Query_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("hasTargetSRFs");
		var_key.val.string.val = strdup("hasTargetSRFs");
		...
		local_node->hasTargetSRFs = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("stmt_location");
		var_key.val.string.val = strdup("stmt_location");
		...
		local_node->stmt_location = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("stmt_len");
		var_key.val.string.val = strdup("stmt_len");
		...
		local_node->stmt_len = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		local_node->override = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *CreatePublicationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CreatePublicationStmt *local_node;
	if (node_cast != NULL)
		local_node = (CreatePublicationStmt *) node_cast;
	else
		local_node = makeNode(CreatePublicationStmt);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("for_all_tables");
		var_key.val.string.val = strdup("for_all_tables");
		...
		local_node->for_all_tables = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("pubname");
		var_key.val.string.val = strdup("pubname");
		...
		if (var_value->type == jbvNull)
			local_node->pubname = NULL;
		else
		{
			char *result = palloc(var_value->val.string.len + 1);
			memcpy(result, var_value->val.string.val, var_value->val.string.len);
			result[var_value->val.string.len] = '\0';
			local_node->pubname = result;
		}
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("tables");
		var_key.val.string.val = strdup("tables");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->tables = NULL;
		else
			local_node->tables = list_deser(var_value->val.binary.data, false);
...
void *ArrayCoerceExpr_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("elemexpr");
		var_key.val.string.val = strdup("elemexpr");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->elemexpr = NULL;
		} else {
			local_node->elemexpr = (Expr *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *ObjectWithArgs_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	ObjectWithArgs *local_node;
	if (node_cast != NULL)
		local_node = (ObjectWithArgs *) node_cast;
	else
		local_node = makeNode(ObjectWithArgs);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("args_unspecified");
		var_key.val.string.val = strdup("args_unspecified");
		...
		local_node->args_unspecified = var_value->val.boolean;
...
void *Aggref_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("aggtranstype");
		var_key.val.string.val = strdup("aggtranstype");
		...
		local_node->aggtranstype = DatumGetUInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("aggsplit");
		var_key.val.string.val = strdup("aggsplit");
		...
		local_node->aggsplit = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("aggargtypes");
		var_key.val.string.val = strdup("aggargtypes");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->aggargtypes = NULL;
		else
			local_node->aggargtypes = list_deser(var_value->val.binary.data, false);
...
void *TableFuncScan_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	TableFuncScan *local_node;
	if (node_cast != NULL)
		local_node = (TableFuncScan *) node_cast;
	else
		local_node = makeNode(TableFuncScan);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("tablefunc");
		var_key.val.string.val = strdup("tablefunc");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->tablefunc = NULL;
		} else {
			local_node->tablefunc = (TableFunc *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *CreateTrigStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("transitionRels");
		var_key.val.string.val = strdup("transitionRels");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->transitionRels = NULL;
		else
			local_node->transitionRels = list_deser(var_value->val.binary.data, false);
...
void *AlterTableCmd_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->newowner = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("num");
		var_key.val.string.val = strdup("num");
		...
		local_node->num = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *AlterFunctionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->func = (ObjectWithArgs *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *ReassignOwnedStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->newrole = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *SQLValueFunction_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	SQLValueFunction *local_node;
	if (node_cast != NULL)
		local_node = (SQLValueFunction *) node_cast;
	else
		local_node = makeNode(SQLValueFunction);
...
void *AlterUserMappingStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->user = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *CreateAmStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CreateAmStmt *local_node;
	if (node_cast != NULL)
		local_node = (CreateAmStmt *) node_cast;
	else
		local_node = makeNode(CreateAmStmt);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("handler_name");
		var_key.val.string.val = strdup("handler_name");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->handler_name = NULL;
		else
			local_node->handler_name = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("amtype");
		var_key.val.string.val = strdup("amtype");
		...
		local_node->amtype = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *CreateFunctionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("is_procedure");
		var_key.val.string.val = strdup("is_procedure");
		...
		local_node->is_procedure = var_value->val.boolean;
...
void *A_Indices_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("is_slice");
		var_key.val.string.val = strdup("is_slice");
		...
		local_node->is_slice = var_value->val.boolean;
...
void *AlterOwnerStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->object = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *CreateTableSpaceStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->owner = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *RangeTableFunc_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	RangeTableFunc *local_node;
	if (node_cast != NULL)
		local_node = (RangeTableFunc *) node_cast;
	else
		local_node = makeNode(RangeTableFunc);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rowexpr");
		var_key.val.string.val = strdup("rowexpr");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->rowexpr = NULL;
		} else {
			local_node->rowexpr = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("namespaces");
		var_key.val.string.val = strdup("namespaces");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->namespaces = NULL;
		else
			local_node->namespaces = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("docexpr");
		var_key.val.string.val = strdup("docexpr");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->docexpr = NULL;
		} else {
			local_node->docexpr = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *Hash_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rows_total");
		var_key.val.string.val = strdup("rows_total");
		...
		local_node->rows_total = DatumGetFloat8(DirectFunctionCall1(numeric_float8, NumericGetDatum(var_value->val.numeric)));
...
void *GatherMerge_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	GatherMerge *local_node;
	if (node_cast != NULL)
		local_node = (GatherMerge *) node_cast;
	else
		local_node = makeNode(GatherMerge);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rescan_param");
		var_key.val.string.val = strdup("rescan_param");
		...
		local_node->rescan_param = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("initParam");
		var_key.val.string.val = strdup("initParam");
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("num_workers");
		var_key.val.string.val = strdup("num_workers");
		...
		local_node->num_workers = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
...
void *TriggerTransition_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	TriggerTransition *local_node;
	if (node_cast != NULL)
		local_node = (TriggerTransition *) node_cast;
	else
		local_node = makeNode(TriggerTransition);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("isNew");
		var_key.val.string.val = strdup("isNew");
		...
		local_node->isNew = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("isTable");
		var_key.val.string.val = strdup("isTable");
		...
		local_node->isTable = var_value->val.boolean;
...
void *Append_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("first_partial_plan");
		var_key.val.string.val = strdup("first_partial_plan");
		...
		local_node->first_partial_plan = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("partitioned_rels");
		var_key.val.string.val = strdup("partitioned_rels");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->partitioned_rels = NULL;
		else
			local_node->partitioned_rels = list_deser(var_value->val.binary.data, false);
...
void *SubPlan_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("parallel_safe");
		var_key.val.string.val = strdup("parallel_safe");
		...
		local_node->parallel_safe = var_value->val.boolean;
...
void *TableFunc_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	TableFunc *local_node;
	if (node_cast != NULL)
		local_node = (TableFunc *) node_cast;
	else
		local_node = makeNode(TableFunc);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("notnulls");
		var_key.val.string.val = strdup("notnulls");
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("coldefexprs");
		var_key.val.string.val = strdup("coldefexprs");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->coldefexprs = NULL;
		else
			local_node->coldefexprs = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("colexprs");
		var_key.val.string.val = strdup("colexprs");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->colexprs = NULL;
		else
			local_node->colexprs = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("ns_uris");
		var_key.val.string.val = strdup("ns_uris");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->ns_uris = NULL;
		else
			local_node->ns_uris = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("ordinalitycol");
		var_key.val.string.val = strdup("ordinalitycol");
		...
		local_node->ordinalitycol = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("ns_names");
		var_key.val.string.val = strdup("ns_names");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->ns_names = NULL;
		else
			local_node->ns_names = list_deser(var_value->val.binary.data, false);
...
void *Gather_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	Gather *local_node;
	if (node_cast != NULL)
		local_node = (Gather *) node_cast;
	else
		local_node = makeNode(Gather);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("invisible");
		var_key.val.string.val = strdup("invisible");
		...
		local_node->invisible = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("single_copy");
		var_key.val.string.val = strdup("single_copy");
		...
		local_node->single_copy = var_value->val.boolean;
...
void *PartitionRangeDatum_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	PartitionRangeDatum *local_node;
	if (node_cast != NULL)
		local_node = (PartitionRangeDatum *) node_cast;
	else
		local_node = makeNode(PartitionRangeDatum);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("value");
		var_key.val.string.val = strdup("value");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->value = NULL;
		} else {
			local_node->value = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *AlterObjectDependsStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	AlterObjectDependsStmt *local_node;
	if (node_cast != NULL)
		local_node = (AlterObjectDependsStmt *) node_cast;
	else
		local_node = makeNode(AlterObjectDependsStmt);
...

	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->extname = (Value *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *InlineCodeBlock_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("atomic");
		var_key.val.string.val = strdup("atomic");
		...
		local_node->atomic = var_value->val.boolean;
...
void *CreateSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CreateSubscriptionStmt *local_node;
	if (node_cast != NULL)
		local_node = (CreateSubscriptionStmt *) node_cast;
	else
		local_node = makeNode(CreateSubscriptionStmt);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("conninfo");
		var_key.val.string.val = strdup("conninfo");
		...
		if (var_value->type == jbvNull)
			local_node->conninfo = NULL;
		else
		{
			char *result = palloc(var_value->val.string.len + 1);
			memcpy(result, var_value->val.string.val, var_value->val.string.len);
			result[var_value->val.string.len] = '\0';
			local_node->conninfo = result;
		}
	}
	{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("publication");
		var_key.val.string.val = strdup("publication");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->publication = NULL;
		else
			local_node->publication = list_deser(var_value->val.binary.data, false);
...
void *RangeTableFuncCol_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	RangeTableFuncCol *local_node;
	if (node_cast != NULL)
		local_node = (RangeTableFuncCol *) node_cast;
	else
		local_node = makeNode(RangeTableFuncCol);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("colexpr");
		var_key.val.string.val = strdup("colexpr");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->colexpr = NULL;
		} else {
			local_node->colexpr = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("coldefexpr");
		var_key.val.string.val = strdup("coldefexpr");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->coldefexpr = NULL;
		} else {
			local_node->coldefexpr = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("for_ordinality");
		var_key.val.string.val = strdup("for_ordinality");
		...
		local_node->for_ordinality = var_value->val.boolean;
...
void *RawStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	RawStmt *local_node;
	if (node_cast != NULL)
		local_node = (RawStmt *) node_cast;
	else
		local_node = makeNode(RawStmt);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("stmt");
		var_key.val.string.val = strdup("stmt");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->stmt = NULL;
		} else {
			local_node->stmt = (Node *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *GrantRoleStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->grantor = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *Join_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("inner_unique");
		var_key.val.string.val = strdup("inner_unique");
		...
		local_node->inner_unique = var_value->val.boolean;
...
void *NextValueExpr_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	NextValueExpr *local_node;
	if (node_cast != NULL)
		local_node = (NextValueExpr *) node_cast;
	else
		local_node = makeNode(NextValueExpr);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("seqid");
		var_key.val.string.val = strdup("seqid");
		...
		local_node->seqid = DatumGetUInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
...
void *CreatePolicyStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("permissive");
		var_key.val.string.val = strdup("permissive");
		...
		local_node->permissive = var_value->val.boolean;
...
void *CreateOpClassItem_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->name = (ObjectWithArgs *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *Constraint_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("generated_when");
		var_key.val.string.val = strdup("generated_when");
		...
		local_node->generated_when = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *ColumnDef_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("is_from_parent");
		var_key.val.string.val = strdup("is_from_parent");
		...
		local_node->is_from_parent = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("identity");
		var_key.val.string.val = strdup("identity");
		...
		local_node->identity = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *Plan_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("parallel_aware");
		var_key.val.string.val = strdup("parallel_aware");
		...
		local_node->parallel_aware = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("plan_node_id");
		var_key.val.string.val = strdup("plan_node_id");
		...
		local_node->plan_node_id = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
...
void *CreateSeqStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("for_identity");
		var_key.val.string.val = strdup("for_identity");
		...
		local_node->for_identity = var_value->val.boolean;
...
void *BitmapOr_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("isshared");
		var_key.val.string.val = strdup("isshared");
		...
		local_node->isshared = var_value->val.boolean;
...
void *AlterRoleStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->role = (RoleSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *PartitionSpec_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	PartitionSpec *local_node;
	if (node_cast != NULL)
		local_node = (PartitionSpec *) node_cast;
	else
		local_node = makeNode(PartitionSpec);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("partParams");
		var_key.val.string.val = strdup("partParams");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->partParams = NULL;
		else
			local_node->partParams = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		if (var_value->type == jbvNull)
			local_node->strategy = NULL;
		else
		{
			char *result = palloc(var_value->val.string.len + 1);
			memcpy(result, var_value->val.string.val, var_value->val.string.len);
			result[var_value->val.string.len] = '\0';
			local_node->strategy = result;
		}
	}
	if (hook)
		return hook(local_node);
...
void *ModifyTable_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("partColsUpdated");
		var_key.val.string.val = strdup("partColsUpdated");
		...
		local_node->partColsUpdated = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rootResultRelIndex");
		var_key.val.string.val = strdup("rootResultRelIndex");
		...
		local_node->rootResultRelIndex = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("fdwDirectModifyPlans");
		var_key.val.string.val = strdup("fdwDirectModifyPlans");
		...
		if (var_value->type == jbvNull)
			local_node->fdwDirectModifyPlans = NULL;
		else
			
			{
				...
				local_node->fdwDirectModifyPlans = result;
			}
...
void *MergeJoin_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("skip_mark_restore");
		var_key.val.string.val = strdup("skip_mark_restore");
		...
		local_node->skip_mark_restore = var_value->val.boolean;
...
void *CallContext_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CallContext *local_node;
	if (node_cast != NULL)
		local_node = (CallContext *) node_cast;
	else
		local_node = makeNode(CallContext);
...
void *AlterCollationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	AlterCollationStmt *local_node;
	if (node_cast != NULL)
		local_node = (AlterCollationStmt *) node_cast;
	else
		local_node = makeNode(AlterCollationStmt);
...
void *PlannedStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("parallelModeNeeded");
		var_key.val.string.val = strdup("parallelModeNeeded");
		...
		local_node->parallelModeNeeded = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rootResultRelations");
		var_key.val.string.val = strdup("rootResultRelations");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->rootResultRelations = NULL;
		else
			local_node->rootResultRelations = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("nonleafResultRelations");
		var_key.val.string.val = strdup("nonleafResultRelations");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->nonleafResultRelations = NULL;
		else
			local_node->nonleafResultRelations = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("dependsOnRole");
		var_key.val.string.val = strdup("dependsOnRole");
		...
		local_node->dependsOnRole = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("paramExecTypes");
		var_key.val.string.val = strdup("paramExecTypes");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->paramExecTypes = NULL;
		else
			local_node->paramExecTypes = list_deser(var_value->val.binary.data, false);
...
void *CreateTransformStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->tosql = (ObjectWithArgs *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->fromsql = (ObjectWithArgs *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *Agg_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("aggParams");
		var_key.val.string.val = strdup("aggParams");
...
void *CallStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CallStmt *local_node;
	if (node_cast != NULL)
		local_node = (CallStmt *) node_cast;
	else
		local_node = makeNode(CallStmt);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("funccall");
		var_key.val.string.val = strdup("funccall");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->funccall = NULL;
		} else {
			local_node->funccall = (FuncCall *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *PartitionElem_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	PartitionElem *local_node;
	if (node_cast != NULL)
		local_node = (PartitionElem *) node_cast;
	else
		local_node = makeNode(PartitionElem);
...
void *PartitionBoundSpec_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	PartitionBoundSpec *local_node;
	if (node_cast != NULL)
		local_node = (PartitionBoundSpec *) node_cast;
	else
		local_node = makeNode(PartitionBoundSpec);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("is_default");
		var_key.val.string.val = strdup("is_default");
		...
		local_node->is_default = var_value->val.boolean;
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("lowerdatums");
		var_key.val.string.val = strdup("lowerdatums");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->lowerdatums = NULL;
		else
			local_node->lowerdatums = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("modulus");
		var_key.val.string.val = strdup("modulus");
		...
		local_node->modulus = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("remainder");
		var_key.val.string.val = strdup("remainder");
		...
		local_node->remainder = DatumGetInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("listdatums");
		var_key.val.string.val = strdup("listdatums");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->listdatums = NULL;
		else
			local_node->listdatums = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("upperdatums");
		var_key.val.string.val = strdup("upperdatums");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->upperdatums = NULL;
		else
			local_node->upperdatums = list_deser(var_value->val.binary.data, false);
...
void *IndexStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("relationId");
		var_key.val.string.val = strdup("relationId");
		...
		local_node->relationId = DatumGetUInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
...
void *NamedTuplestoreScan_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	NamedTuplestoreScan *local_node;
	if (node_cast != NULL)
		local_node = (NamedTuplestoreScan *) node_cast;
	else
		local_node = makeNode(NamedTuplestoreScan);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("enrname");
		var_key.val.string.val = strdup("enrname");
		...
		if (var_value->type == jbvNull)
			local_node->enrname = NULL;
		else
		{
			char *result = palloc(var_value->val.string.len + 1);
			memcpy(result, var_value->val.string.val, var_value->val.string.len);
			result[var_value->val.string.len] = '\0';
			local_node->enrname = result;
		}
	}
	{
...
void *AlterSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	AlterSubscriptionStmt *local_node;
	if (node_cast != NULL)
		local_node = (AlterSubscriptionStmt *) node_cast;
	else
		local_node = makeNode(AlterSubscriptionStmt);
...
void *DropSubscriptionStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	DropSubscriptionStmt *local_node;
	if (node_cast != NULL)
		local_node = (DropSubscriptionStmt *) node_cast;
	else
		local_node = makeNode(DropSubscriptionStmt);
...
void *CreateStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("partbound");
		var_key.val.string.val = strdup("partbound");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->partbound = NULL;
		} else {
			local_node->partbound = (PartitionBoundSpec *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("partspec");
		var_key.val.string.val = strdup("partspec");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->partspec = NULL;
		} else {
			local_node->partspec = (PartitionSpec *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *AlterOperatorStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	AlterOperatorStmt *local_node;
	if (node_cast != NULL)
		local_node = (AlterOperatorStmt *) node_cast;
	else
		local_node = makeNode(AlterOperatorStmt);
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->opername = (ObjectWithArgs *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *PartitionCmd_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	PartitionCmd *local_node;
	if (node_cast != NULL)
		local_node = (PartitionCmd *) node_cast;
	else
		local_node = makeNode(PartitionCmd);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("bound");
		var_key.val.string.val = strdup("bound");
		...
		if (var_value->type == jbvNull) 
		{
			local_node->bound = NULL;
		} else {
			local_node->bound = (PartitionBoundSpec *) jsonb_to_node(var_value->val.binary.data);
		}
	...
	}
	{
		...
		if (var_value->type == jbvNull) 
		{
			...
			local_node->name = (RangeVar *) jsonb_to_node(var_value->val.binary.data);
		}
...
void *AlterEnumStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("oldVal");
		var_key.val.string.val = strdup("oldVal");
		...
		if (var_value->type == jbvNull)
			local_node->oldVal = NULL;
		else
		{
			char *result = palloc(var_value->val.string.len + 1);
			memcpy(result, var_value->val.string.val, var_value->val.string.len);
			result[var_value->val.string.len] = '\0';
			local_node->oldVal = result;
		}
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("skipIfNewValExists");
		var_key.val.string.val = strdup("skipIfNewValExists");
		...
		local_node->skipIfNewValExists = var_value->val.boolean;
...
void *RangeTblEntry_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("enrtuples");
		var_key.val.string.val = strdup("enrtuples");
		...
		local_node->enrtuples = DatumGetFloat8(DirectFunctionCall1(numeric_float8, NumericGetDatum(var_value->val.numeric)));
...
void *CreateStatsStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	CreateStatsStmt *local_node;
	if (node_cast != NULL)
		local_node = (CreateStatsStmt *) node_cast;
	else
		local_node = makeNode(CreateStatsStmt);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("exprs");
		var_key.val.string.val = strdup("exprs");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->exprs = NULL;
		else
			local_node->exprs = list_deser(var_value->val.binary.data, false);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("stat_types");
		var_key.val.string.val = strdup("stat_types");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->stat_types = NULL;
		else
			local_node->stat_types = list_deser(var_value->val.binary.data, false);
...
void *VacuumRelation_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	VacuumRelation *local_node;
	if (node_cast != NULL)
		local_node = (VacuumRelation *) node_cast;
	else
		local_node = makeNode(VacuumRelation);
	...
	}
	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("oid");
		var_key.val.string.val = strdup("oid");
		...
		local_node->oid = DatumGetUInt32(DirectFunctionCall1(numeric_int4, NumericGetDatum(var_value->val.numeric)));
...
void *AlterPublicationStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
	AlterPublicationStmt *local_node;
	if (node_cast != NULL)
		local_node = (AlterPublicationStmt *) node_cast;
	else
		local_node = makeNode(AlterPublicationStmt);
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("tableAction");
		var_key.val.string.val = strdup("tableAction");
		...
		local_node->tableAction = DatumGetInt16(DirectFunctionCall1(numeric_int2, NumericGetDatum(var_value->val.numeric)));
...
void *VacuumStmt_deser(JsonbContainer *container, void *node_cast, int replace_type)
{
...

	{
		...
		JsonbValue var_key;
		var_key.type = jbvString;
		var_key.val.string.len = strlen("rels");
		var_key.val.string.val = strdup("rels");
		...
		if (var_value == NULL || var_value->type == jbvNull)
			local_node->rels = NULL;
		else
			local_node->rels = list_deser(var_value->val.binary.data, false);
...
void *jsonb_to_node(JsonbContainer *container)
{
	...
	switch (node_type_value)
	{
		...
		case T_ProjectSet:
			return ProjectSet_deser(container, NULL, -1);
		...
		case T_CreatePublicationStmt:
			return CreatePublicationStmt_deser(container, NULL, -1);
		case T_Scan:
			return Scan_deser(container, NULL, -1);
		case T_ArrayCoerceExpr:
			return ArrayCoerceExpr_deser(container, NULL, -1);
		case T_ObjectWithArgs:
			return ObjectWithArgs_deser(container, NULL, -1);
		case T_ListenStmt:
		...
		case T_TableFuncScan:
			return TableFuncScan_deser(container, NULL, -1);
		...
		case T_SQLValueFunction:
			return SQLValueFunction_deser(container, NULL, -1);
		case T_DropRoleStmt:
		...
		case T_CreateAmStmt:
			return CreateAmStmt_deser(container, NULL, -1);
		case T_A_Star:
		...
		case T_RangeTableFunc:
			return RangeTableFunc_deser(container, NULL, -1);
		case T_Hash:
		...
		case T_GatherMerge:
			return GatherMerge_deser(container, NULL, -1);
		case T_TriggerTransition:
			return TriggerTransition_deser(container, NULL, -1);
		...
		case T_TableFunc:
			return TableFunc_deser(container, NULL, -1);
		case T_TypeCast:
			return TypeCast_deser(container, NULL, -1);
		case T_Gather:
			return Gather_deser(container, NULL, -1);
		case T_PartitionRangeDatum:
			return PartitionRangeDatum_deser(container, NULL, -1);
		case T_NestLoopParam:
			return NestLoopParam_deser(container, NULL, -1);
		case T_GroupingFunc:
			return GroupingFunc_deser(container, NULL, -1);
		case T_AlterObjectDependsStmt:
			return AlterObjectDependsStmt_deser(container, NULL, -1);
		case T_FieldSelect:
		...
		case T_CreateSubscriptionStmt:
			return CreateSubscriptionStmt_deser(container, NULL, -1);
		case T_RoleSpec:
		...
		case T_RangeTableFuncCol:
			return RangeTableFuncCol_deser(container, NULL, -1);
		case T_ParamRef:
		...
		case T_RawStmt:
			return RawStmt_deser(container, NULL, -1);
		case T_Result:
		...
		case T_NextValueExpr:
			return NextValueExpr_deser(container, NULL, -1);
		case T_NamedArgExpr:
		...
		case T_PartitionSpec:
			return PartitionSpec_deser(container, NULL, -1);
		case T_ModifyTable:
		...
		case T_CallContext:
			return CallContext_deser(container, NULL, -1);
		...
		case T_AlterCollationStmt:
			return AlterCollationStmt_deser(container, NULL, -1);
		...
		case T_CallStmt:
			return CallStmt_deser(container, NULL, -1);
		case T_BoolExpr:
		...
		case T_PartitionElem:
			return PartitionElem_deser(container, NULL, -1);
		case T_WindowClause:
			return WindowClause_deser(container, NULL, -1);
		case T_PrepareStmt:
			return PrepareStmt_deser(container, NULL, -1);
		case T_PartitionBoundSpec:
			return PartitionBoundSpec_deser(container, NULL, -1);
		...
		case T_NamedTuplestoreScan:
			return NamedTuplestoreScan_deser(container, NULL, -1);
		case T_RenameStmt:
		...
		case T_AlterSubscriptionStmt:
			return AlterSubscriptionStmt_deser(container, NULL, -1);
		case T_DropSubscriptionStmt:
			return DropSubscriptionStmt_deser(container, NULL, -1);
		case T_PlanRowMark:
		...
		case T_AlterOperatorStmt:
			return AlterOperatorStmt_deser(container, NULL, -1);
		case T_IndexScan:
			return IndexScan_deser(container, NULL, -1);
		case T_PartitionCmd:
			return PartitionCmd_deser(container, NULL, -1);
		...
		case T_CreateStatsStmt:
			return CreateStatsStmt_deser(container, NULL, -1);
		...
		case T_VacuumRelation:
			return VacuumRelation_deser(container, NULL, -1);
		case T_AlterTSConfigurationStmt:
			return AlterTSConfigurationStmt_deser(container, NULL, -1);
		case T_AlterPublicationStmt:
			return AlterPublicationStmt_deser(container, NULL, -1);
		case T_SecLabelStmt:
